...
<head>
    <meta charset="UTF-8">
    <title>Crear Producto - Hotel Rizzo</title>
    ...
    <main class="main-content">
        <div class="form-container">
            <div class="form-header">
                ...
                <p class="form-subtitle">Complete los datos para registrar un nuevo producto</p>
            </div>
            
            <form action="producto_crear" method="post" class="producto-form">
                <div class="form-group">
                    <label for="nombre">Nombre del Producto</label>
                    <input type="text" id="nombre" name="nombre" required placeholder="Ej. Agua Mineral, Snack...">
                </div>
                
                <div class="form-group">
                    <label for="descripcion">Descripción</label>
                    <textarea id="descripcion" name="descripcion" rows="3" required placeholder="Descripción detallada del producto..."></textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="stockMinimo" name="stockMinimo" required placeholder="Mínimo requerido">
                </div>
